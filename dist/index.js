...
// node_modules/.pnpm/@adversarylabs+sdk@0.1.17/node_modules/@adversarylabs/sdk/dist/index.js
...
// node_modules/.pnpm/@adversarylabs+sdk@0.1.17/node_modules/@adversarylabs/sdk/dist/model.js
...
// node_modules/.pnpm/@adversarylabs+sdk@0.1.17/node_modules/@adversarylabs/sdk/dist/repo-graph.js
...
// node_modules/.pnpm/@adversarylabs+sdk@0.1.17/node_modules/@adversarylabs/sdk/dist/repo-index.js
...
// node_modules/.pnpm/@adversarylabs+sdk@0.1.17/node_modules/@adversarylabs/sdk/dist/repository-model.js
...
// node_modules/.pnpm/@adversarylabs+sdk@0.1.17/node_modules/@adversarylabs/sdk/dist/sources.js
...
// node_modules/.pnpm/@adversarylabs+sdk@0.1.17/node_modules/@adversarylabs/sdk/dist/manifest.js
    ...
    findings: {
      ...
      items: {
        ...
        properties: {
          ...
          convention: { type: "string", minLength: 20, maxLength: 2e3 },
          deviation: { type: "string", minLength: 20, maxLength: 2e3 },
          impact: { type: "string", minLength: 10, maxLength: 1500 },
          fix: { type: "string", minLength: 10, maxLength: 1500 },
          evidence: {
            type: "array",
            minItems: 2,
            maxItems: 10,
...
var repositoryTools = {
  repository: {
    ...
    maxToolCalls: 80,
    maxTotalBytes: 72e4,
    maxBytesPerRead: 64e3,
    maxLinesPerRead: 800,
    directoryPageSize: 300,
    planningTimeoutMs: 18e4
  }
};
function createApp() {
...
function buildGraphHints(ctx, changedFiles) {
  ...
  return changedFiles.slice(0, 40).map((path) => {
    ...
    return {
      ...
      imports: ctx.repoGraph?.importsOf(path, void 0, 12).items.map((edge) => edge.toPath ?? edge.unresolvedTarget) ?? [],
      importers: ctx.repoGraph?.importersOf(path, void 0, 12).items.map((edge) => edge.fromPath) ?? [],
